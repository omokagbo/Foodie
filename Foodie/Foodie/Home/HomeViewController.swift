...
class HomeViewController: UIViewController {
    ...
    var categories: [DishCategory] = [
        .init(id: "id1", name: "African Dish", image: "https://picsum.photos/200/200"),
        .init(id: "id2", name: "American Dish", image: "https://picsum.photos/200/200"),
        .init(id: "id3", name: "Asian Dish", image: "https://picsum.photos/200/200"),
        .init(id: "id4", name: "European Dish", image: "https://picsum.photos/200/200"),
        .init(id: "id5", name: "Australian Dish", image: "https://picsum.photos/200/200")
    ]
    ...
    var specialDishes: [PopularDish] = [
        .init(id: "id1", name: "Plantain", description: "Fried plantain with sauce", image: "https://picsum.photos/200/200", calories: 150),
        .init(id: "id2", name: "Boli", description: "Roasted plantain that catches the eye", image: "https://picsum.photos/200/200", calories: 200),
        .init(id: "id3", name: "Pounded Yam", description: "Finest pounded yam with all kinds of soup", image: "https://picsum.photos/200/200", calories: 300),
        .init(id: "id4", name: "Pepper Soup", description: "Fish, bush meat, turkey or beef pepper soup", image: "https://picsum.photos/200/200", calories: 100),
        .init(id: "id5", name: "Coconut rice", description: "Coconut rice delicacy like you have never tasted before", image: "https://picsum.photos/200/200", calories: 140)
    ]
